...
<head>
<meta charset="utf-8">
<title><?php echo"About $projectname";?></title>
...
<body>
	<div id="bg">
		<div class="wrap">
            ...
            <!-- main -->
			<div id="main">
				<h2 class="inner">About Project</h2>
				
				<img src="images/thumb1.png" alt="Image" class="left" />
				<p><?php echo"$aboutprojectcolumn1";?></p>
				
				<h3><?php echo"$aboutprojectsubtitle1";?></h3>
				<img src="images/thumb2.png" alt="Image" class="right" />
				<p><?php echo"$aboutprojectcolumn2";?></p>
				
				<h4><?php echo"$aboutprojectsubtitle2";?></h4>
				<p><?php echo"$aboutprojectcolumn3";?></p>
			</div>
			<!-- /main -->
