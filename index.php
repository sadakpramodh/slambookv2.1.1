	...
	<div id="bg">
		<div class="wrap">
			...
			<div id="main">
				<div id="intro">
					<h2>Welcome</h2>
					<p><?php echo"$welcomenote"; ?></p>
                    
                <a href="slambook/index.php"><img src="images/slambook.JPG" width="290" height="65" alt="slambook" title="Click here for go to slambook!"></a> </div>
