...
<head>
<meta charset="utf-8">
<title><?php echo"$projectname;";?>Developers</title>
...
<body>
	<div id="bg">
		<div class="wrap">
			...
			<div id="main">
				<div id="page">
					<h2 class="inner">Developers Note</h2>
					<p><?php echo"$developersnote";?></p>
					...
					<table class="table">
						...
						<tbody>
							<tr>
								<td><?php echo"$developeroneid";?></td>
								<td><?php echo"$developerone";?></td>
								<td><?php echo"$developeroneroleofwork";?></td>
                                <td><?php echo"$developeroneemailid";?></td>
							</tr>
							<tr class="odd">
								<td><?php echo"$developertwoid";?></td>
								<td><?php echo"$developertwo";?></td>
								<td><?php echo"$developertworoleofwork";?></td>
                                <td><?php echo"$developertwoemailid";?></td>
							</tr>
							<tr>
								<td><?php echo"$developerthreeid";?></td>
								<td><?php echo"$developerthree";?></td>
								<td><?php echo"$developerthreeroleofwork";?></td>
                                <td><?php echo"$developerthreeemailid";?></td>
							</tr>
							<tr class="odd">
								<td><?php echo"$developerfourid";?></td>
								<td><?php echo"$developerfour";?></td>
								<td><?php echo"$developerfourroleofwork";?></td>
                                <td><?php echo"$developerfouremailid";?></td>
							</tr>
