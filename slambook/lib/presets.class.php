...
class presets {
  ...
  function GenerateNavbar() {
      ...
      $var[] = array("dropdown",
                      array(  0 => array("href" => "https://www.facebook.com/slambookproject",
                                       "name" => "slambook on Facebook",
                                       "class" => 0),

                              1 => array("href" => "http://github.com/sadakpramodh",
      ...
      $var[] = array("dropdown",
                      array(  array("href" => $set->url."/profile.php?u=".$user->data->userid,
                              ...
                              array("href" => $set->url."/privacy.php",
                                       ...
                                       "class" => 0),
							  array("href" => $set->url."/predefineyourdata.php",
                                       "name" => "<i class=\"icon-fixed-width icon-pencil\"></i> Preset your details in slambook",
                                       "class" => 0),
							  array("href" => $set->url."/yourslambookhistory.php",
                                       "name" => "<i class=\"icon-fixed-width icon-book\"></i> Your slambook history",
                                       "class" => 0),   
